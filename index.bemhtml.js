...
/* begin: D:\var\contrib\my-vcard\libs\bem-core\common.blocks\ua\ua.bemhtml */
block('ua')(
    tag()('script'),
    bem()(false),
    content()([
...
/* end: D:\var\contrib\my-vcard\libs\bem-core\common.blocks\ua\ua.bemhtml */
/* begin: D:\var\contrib\my-vcard\libs\bem-core\common.blocks\page\__css\page__css.bemhtml */
block('page').elem('css')(
    bem()(false),
    tag()('style'),
...
/* end: D:\var\contrib\my-vcard\libs\bem-core\common.blocks\page\__css\page__css.bemhtml */
/* begin: D:\var\contrib\my-vcard\libs\bem-core\desktop.blocks\page\__css\page__css.bemhtml */
...
/* end: D:\var\contrib\my-vcard\libs\bem-core\desktop.blocks\page\__css\page__css.bemhtml */
/* begin: D:\var\contrib\my-vcard\libs\bem-core\common.blocks\page\__js\page__js.bemhtml */
block('page').elem('js')(
    bem()(false),
    tag()('script'),
    attrs()(function() {
...
/* end: D:\var\contrib\my-vcard\libs\bem-core\common.blocks\page\__js\page__js.bemhtml */
/* begin: D:\var\contrib\my-vcard\libs\bem-components\common.blocks\link\link.bemhtml */
block('link')(
    def()(function() {
        var ctx = this.ctx;
...
/* end: D:\var\contrib\my-vcard\libs\bem-components\common.blocks\link\link.bemhtml */
/* begin: D:\var\contrib\my-vcard\libs\bem-components\common.blocks\link\_pseudo\link_pseudo.bemhtml */
...
/* end: D:\var\contrib\my-vcard\libs\bem-components\common.blocks\link\_pseudo\link_pseudo.bemhtml */
/* begin: D:\var\contrib\my-vcard\common.blocks\b-image\b-image.bemhtml */
block('b-image')(
    tag()('img'),
...
/* end: D:\var\contrib\my-vcard\common.blocks\b-image\b-image.bemhtml */
/* begin: D:\var\contrib\my-vcard\common.blocks\b-info\b-info.bemhtml */
block('b-info')(
    content()(function () {
        return [
            {
        ...
        content()(function () {
            return [
                ...
                },
                {
                    elem: 'person',
                    content: [
                        this.ctx.info.person.email ? [{
                            elem: 'email',
                            content: this.ctx.info.person.email
                        }, {tag: 'br'}] : '',
                        this.ctx.info.person.github ? [{
                            elem: 'github',
                            content: this.ctx.info.person.github
                        }, {tag: 'br'}] : '',
                        this.ctx.info.person.skype ? [{
                            elem: 'skype',
                            lang: this.ctx.lang,
                            content: this.ctx.info.person.skype
                        }] : ''
                    ]
                }
            ]
    ...
    elem('github')(
        ...
        cls()('github'),
        attrs()(function(){
            return {href: 'https://github.com/' + this.ctx.content};
        }),
        content()(function() {
            return 'github.com/' + this.ctx.content;
        })
    ),
...
/* end: D:\var\contrib\my-vcard\common.blocks\b-info\b-info.bemhtml */
/* begin: D:\var\contrib\my-vcard\libs\bem-core\common.blocks\page\page.bemhtml */
block('page')(
...
/* end: D:\var\contrib\my-vcard\libs\bem-core\common.blocks\page\page.bemhtml */
/* begin: D:\var\contrib\my-vcard\common.blocks\page\page.bemhtml */
block('page')(
    ...
    def().match(function() { return !this._pageInit; })(function() {
        var ctx = this.ctx;
        this._nonceCsp = ctx.nonce;
        this.i18n = this.ctx.i18n || { langs: ['ru'], lang: 'ru' }
...
/* end: D:\var\contrib\my-vcard\common.blocks\page\page.bemhtml */
/* begin: D:\var\contrib\my-vcard\common.blocks\b-card\b-card.bemhtml */
block('b-card')(
...
/* end: D:\var\contrib\my-vcard\common.blocks\b-card\b-card.bemhtml */
/* begin: D:\var\contrib\my-vcard\common.blocks\b-card-layout\b-card-layout.bemhtml */
block('b-card-layout')(
...
/* end: D:\var\contrib\my-vcard\common.blocks\b-card-layout\b-card-layout.bemhtml */
