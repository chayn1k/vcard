...
/* begin: ../../common.blocks/b-card/b-card.js */
...
modules.define(
    ...
    function(provide, BEMDOM, $) {
         ...
         */
        provide(BEMDOM.decl(this.name, /** @lends b-card.prototype */{
            ...
            onSetMod : {
                ...
                js : {
                    inited: function() {
                        ...
                        $.each(this.findBlocksInside('switch', 'link'), function () {
                            ...
                            this.on('click', function () {
                                ...
                                if (!titles[lang]) {
                                    ...
                                    titles[lang] = info.elem('name').text() + ' — ' + info.elem('position').text();
                                }
...
/* end: ../../common.blocks/b-card/b-card.js */
